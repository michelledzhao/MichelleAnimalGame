   ...
   public void update(Graphics window)
   {
	...
	public void paint( Graphics window )
	{
		if(title){
			...
			window.setFont(new Font("Impact", Font.BOLD, 96));
			window.drawString("HUNGRY HIPPO", 50, 100);

			window.setFont(new Font("Impact", Font.BOLD, 36));
			...
			window.setFont(new Font("Impact", Font.PLAIN, 25));
			window.drawString("Use the left and right arrows to move the pig.", 10, 350);
		}
